...
import 'schema/cocktail_record.dart';
...
export 'schema/cocktail_record.dart';
...
/// Functions to query CocktailRecords (as a Stream and as a Future).
Stream<List<CocktailRecord>> queryCocktailRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CocktailRecord.collection,
...
Future<List<CocktailRecord>> queryCocktailRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CocktailRecord>> queryCocktailRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
Future<FFFirestorePage<InfoRecord>> queryInfoRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
Future<FFFirestorePage<GameRecord>> queryGameRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
